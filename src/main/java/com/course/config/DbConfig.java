...
//просканировать эту папку и найти все репозитории и энтити
@EnableJpaRepositories(value = "com.course.mvc.repository")
public class DbConfig {
    ...
    @Bean //чтобы настроить до, передать параметры
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        LocalContainerEntityManagerFactoryBean entityManagerFactoryBean = new LocalContainerEntityManagerFactoryBean();
        entityManagerFactoryBean.setDataSource(dataSource());
        entityManagerFactoryBean.setPersistenceProviderClass(HibernatePersistenceProvider.class);
        entityManagerFactoryBean.setPackagesToScan(env.getRequiredProperty(PROP_ENTITYMANAGER_PACKAGES_TO_SCAN));//включается спринг дата
